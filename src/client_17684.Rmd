...
if(crop == "Maize"){
  remark.csv <- read.csv('/home/satyukt/Projects/1000/soil_health/data/report_remarks/maize.csv')
} else if(crop == "Green_Gram"){
  remark.csv <-  read.csv('/home/satyukt/Projects/1000/soil_health/data/report_remarks/green_gram.csv')
} else{
  remark.csv <- read.csv("/home/satyukt/Projects/1000/soil_health/data/report_remarks/remarks.csv")
}
...
sat_logo <- '/home/satyukt/Projects/1000/soil_health/data/logos_17684/satyukt_logo.png'
magi_logo <- '/home/satyukt/Projects/1000/soil_health/data/logos_17684/magicbloom_logo.jpg'
rashtr_logo <- '/home/satyukt/Projects/1000/soil_health/data/logos_17684/logo.jpg'
...
\centering {\LARGE \textcolor{Color2}{\textbf{RAITAMITRA SOCIAL TRUST(R)}}}

\begin{figure}[!htb]
   \begin{minipage}{0.48\textwidth}
     \centering
     \caption*{\emph{Presented by}}
     \includegraphics[width = 3cm, height = 3cm]{`r sat_logo`}
     {\caption*{\textbf{Satyukt Analytics Pvt.Ltd.}}}
   \end{minipage}\hfill
   \begin{minipage}{0.48\textwidth}
     \centering
     \caption*{\emph{In Collaboration with}}
     \includegraphics[width = 3cm, height = 3cm]{`r magi_logo`}
     \caption*{\textbf{Organic Foilar Spray}}\label{Fig:Data2}
   \end{minipage}
\end{figure}
...
\end{tblr}
\thispagestyle{fancy}
\fancyfoot[C]{\#201, 1st Floor Kundagol Complex, Hubli-29. Contact: 0836-3570088\\
